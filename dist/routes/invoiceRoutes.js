...
const createInvoiceRouter = ({ supabase }) => {
    ...
    router.post('/', (0, express_async_handler_1.default)(async (req, res) => {
        ...
        const { customerId, invoiceNumber, issueDate, dueDate, items, additionalCharges, taxRate, discountEnabled, discountDescription, discountType, discountValue, msaContent, msaCoverPageTemplateId, termsAndConditions, status, paymentTerms, customPaymentTerms, commitmentPeriod, customCommitmentPeriod, paymentFrequency, customPaymentFrequency, serviceStartDate, serviceEndDate } = req.body;
        try {
